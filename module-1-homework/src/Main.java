    ...
    public static void main(String[] args) {
        ...
        List<Student> students = new ArrayList<>(Arrays.asList(
                new Student(
                        ...
                        "+7 (912) 345-67-89",
                        Arrays.asList(
                                availableBooks.get(0), availableBooks.get(1), availableBooks.get(1),
                ...
                new Student(
                        ...
                        "+7 (945) 678-90-12",
                        Arrays.asList(
                                availableBooks.get(15), availableBooks.get(11), availableBooks.get(6),
                                availableBooks.get(15), availableBooks.get(15), availableBooks.get(0),
                ...
                new Student(
                        ...
                        "+7 (956) 789-01-23",
                        Arrays.asList(
                                availableBooks.get(0), availableBooks.get(0), availableBooks.get(19),
